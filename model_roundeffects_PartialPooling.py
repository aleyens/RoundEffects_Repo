...
fig,ax = plt.subplots(layout='constrained')
ax.hist(dfPrior_condH1.loc[((dfPrior_condH1['r']==1)),'delta_WR'].values.flatten(),bins=50, label='r1',alpha = 0.5, color='red')
sb.kdeplot(dfPrior_condH1.loc[((dfPrior_condH1['r']==1)),'delta_WR'].values.flatten(), alpha = 0.5, color='red')
ax.hist(dfPrior_condH1.loc[((dfPrior_condH1['r']==0)),'delta_WR'].values.flatten(),bins=50, label='r0',alpha = 0.3, color='blue')
sb.kdeplot(dfPrior_condH1.loc[((dfPrior_condH1['r']==0)),'delta_WR'].values.flatten(), alpha = 0.5, color='blue')
ax.set(xlabel='Value of delta_WR', ylabel='Frequency in the dummy data')
ax.legend(loc='upper right')
#%% Figure 2, first row, right plot
fig,ax = plt.subplots(layout='constrained')
ax.hist(dfPrior_condH1.loc[(dfPrior_condH1['r']==2) ,'delta_SS'].values.flatten(),bins=50, label='r2',alpha = 0.5, color='green')
sb.kdeplot(dfPrior_condH1.loc[((dfPrior_condH1['r']==2)),'delta_SS'].values.flatten(), alpha = 0.5, color='green')
ax.hist(dfPrior_condH1.loc[((dfPrior_condH1['r']==1)),'delta_SS'].values.flatten(),bins=50, label='r1',alpha = 0.5, color='red')
sb.kdeplot(dfPrior_condH1.loc[((dfPrior_condH1['r']==1)),'delta_SS'].values.flatten(), alpha = 0.5, color='red')
...
#%% Figure 2, first row, left plot
fig,ax = plt.subplots(layout='constrained')
sb.kdeplot(dummy_sample_H1_posteriorSample['sigma_round'][0,:,0,0].flatten(), label='$\sigma_{control,0}$', color='darkgreen', alpha=0.7)
sb.kdeplot(dummy_sample_H1_posteriorSample['sigma_round'][1,:,0,0].flatten(),  color='darkgreen', alpha=0.5)
sb.kdeplot(dummy_sample_H1_posteriorSample['sigma_round'][2,:,0,0].flatten(),  color='darkgreen', alpha=0.5)
sb.kdeplot(dummy_sample_H1_posteriorSample['sigma_round'][3,:,0,0].flatten(),  color='darkgreen', alpha=0.5)
sb.kdeplot(dummy_sample_H1_posteriorSample['sigma_round'][0,:,0,1].flatten(), label='$\sigma_{control,1}$', color='darkred', alpha=0.7)
sb.kdeplot(dummy_sample_H1_posteriorSample['sigma_round'][1,:,0,1].flatten(),  color='darkred', alpha=0.5)
sb.kdeplot(dummy_sample_H1_posteriorSample['sigma_round'][2,:,0,1].flatten(),  color='darkred', alpha=0.5)
sb.kdeplot(dummy_sample_H1_posteriorSample['sigma_round'][3,:,0,1].flatten(),  color='darkred', alpha=0.5)
sb.kdeplot(dummy_sample_H1_posteriorSample['sigma_round'][0,:,0,2].flatten(), label='$\sigma_{control,2}$', color='darkblue', alpha=0.7)
sb.kdeplot(dummy_sample_H1_posteriorSample['sigma_round'][1,:,0,2].flatten(),  color='darkblue', alpha=0.5)
sb.kdeplot(dummy_sample_H1_posteriorSample['sigma_round'][2,:,0,2].flatten(),  color='darkblue', alpha=0.5)
sb.kdeplot(dummy_sample_H1_posteriorSample['sigma_round'][3,:,0,2].flatten(),  color='darkblue', alpha=0.5)
sb.kdeplot(dummy_sample_H1_posteriorSample['sigma_round'][0,:,1,0].flatten(), label='$\sigma_{treat,0}$', color='lightgreen', alpha=0.7)
sb.kdeplot(dummy_sample_H1_posteriorSample['sigma_round'][1,:,1,0].flatten(),  color='lightgreen', alpha=0.5)
sb.kdeplot(dummy_sample_H1_posteriorSample['sigma_round'][2,:,1,0].flatten(),  color='lightgreen', alpha=0.5)
sb.kdeplot(dummy_sample_H1_posteriorSample['sigma_round'][3,:,1,0].flatten(),  color='lightgreen', alpha=0.5)
sb.kdeplot(dummy_sample_H1_posteriorSample['sigma_round'][0,:,1,1].flatten(), label='$\sigma_{treat,1}$', color='darkorange', alpha=0.7)
sb.kdeplot(dummy_sample_H1_posteriorSample['sigma_round'][1,:,1,1].flatten(),  color='darkorange', alpha=0.5)
sb.kdeplot(dummy_sample_H1_posteriorSample['sigma_round'][2,:,1,1].flatten(),  color='darkorange', alpha=0.5)
sb.kdeplot(dummy_sample_H1_posteriorSample['sigma_round'][3,:,1,1].flatten(),  color='darkorange', alpha=0.5)
sb.kdeplot(dummy_sample_H1_posteriorSample['sigma_round'][0,:,1,2].flatten(), label='$\sigma_{treat,2}$', color='lightblue', alpha=0.7)
sb.kdeplot(dummy_sample_H1_posteriorSample['sigma_round'][1,:,1,2].flatten(),  color='lightblue', alpha=0.5)
sb.kdeplot(dummy_sample_H1_posteriorSample['sigma_round'][2,:,1,2].flatten(),  color='lightblue', alpha=0.5)
sb.kdeplot(dummy_sample_H1_posteriorSample['sigma_round'][3,:,1,2].flatten(),  color='lightblue', alpha=0.5)
...
fig,ax = plt.subplots(layout='constrained')
sb.kdeplot(dummy_sample_H1_posteriorSample['theta'][1,:,0,0].flatten(), label='$\\theta_{WR,0}$', color='green', alpha=0.7)
sb.kdeplot(dummy_sample_H1_posteriorSample['theta'][2,:,0,0].flatten(),  color='green', alpha=0.5)
sb.kdeplot(dummy_sample_H1_posteriorSample['theta'][3,:,0,0].flatten(),  color='green', alpha=0.5)
sb.kdeplot(dummy_sample_H1_posteriorSample['theta'][0,:,0,0].flatten(),  color='green', alpha=0.5)
sb.kdeplot(dummy_sample_H1_posteriorSample['theta'][1,:,0,1].flatten(), label='$\\theta_{WR,1}$', color='red', alpha=0.5)
sb.kdeplot(dummy_sample_H1_posteriorSample['theta'][2,:,0,1].flatten(),  color='red', alpha=0.5)
sb.kdeplot(dummy_sample_H1_posteriorSample['theta'][3,:,0,1].flatten(),  color='red', alpha=0.5)
sb.kdeplot(dummy_sample_H1_posteriorSample['theta'][0,:,0,1].flatten(),  color='red', alpha=0.5)
sb.kdeplot(dummy_sample_H1_posteriorSample['theta'][1,:,0,2].flatten(), label='$\\theta_{WR,2}$', color='blue', alpha=0.5)
sb.kdeplot(dummy_sample_H1_posteriorSample['theta'][2,:,0,2].flatten(),  color='blue', alpha=0.5)
sb.kdeplot(dummy_sample_H1_posteriorSample['theta'][3,:,0,2].flatten(),  color='blue', alpha=0.5)
sb.kdeplot(dummy_sample_H1_posteriorSample['theta'][0,:,0,2].flatten(),  color='blue', alpha=0.5)
sb.kdeplot(dummy_sample_H1_posteriorSample['theta'][0,:,1,0].flatten(), label='$\\theta_{SS,0}$', color='purple', alpha=0.7)
sb.kdeplot(dummy_sample_H1_posteriorSample['theta'][1,:,1,0].flatten(),  color='purple', alpha=0.5)
sb.kdeplot(dummy_sample_H1_posteriorSample['theta'][2,:,1,0].flatten(),  color='purple', alpha=0.5)
sb.kdeplot(dummy_sample_H1_posteriorSample['theta'][3,:,1,0].flatten(),  color='purple', alpha=0.5)
sb.kdeplot(dummy_sample_H1_posteriorSample['theta'][0,:,1,1].flatten(), label='$\\theta_{SS,1}$', color='orange', alpha=0.5)
sb.kdeplot(dummy_sample_H1_posteriorSample['theta'][1,:,1,1].flatten(),  color='orange', alpha=0.5)
sb.kdeplot(dummy_sample_H1_posteriorSample['theta'][2,:,1,1].flatten(),  color='orange', alpha=0.5)
sb.kdeplot(dummy_sample_H1_posteriorSample['theta'][3,:,1,1].flatten(),  color='orange', alpha=0.5)
sb.kdeplot(dummy_sample_H1_posteriorSample['theta'][0,:,1,2].flatten(), label='$\\theta_{SS,2}$', color='grey', alpha=0.5)
sb.kdeplot(dummy_sample_H1_posteriorSample['theta'][1,:,1,2].flatten(),  color='grey', alpha=0.5)
sb.kdeplot(dummy_sample_H1_posteriorSample['theta'][2,:,1,2].flatten(),  color='grey', alpha=0.5)
sb.kdeplot(dummy_sample_H1_posteriorSample['theta'][3,:,1,2].flatten(),  color='grey', alpha=0.5)
ax.axvline(x=-0.2, color='black', ls='--', lw=2, label='Cond.Value')
...
# Figure 3, left plot
fig,ax = plt.subplots(layout='constrained')
sb.kdeplot(dummy_sample_H2_posteriorSample['sigma_round'][0,:,0,0].flatten(), label='$\sigma_{control,0}$', color='darkgreen', alpha=0.7)
sb.kdeplot(dummy_sample_H2_posteriorSample['sigma_round'][1,:,0,0].flatten(),  color='darkgreen', alpha=0.5)
sb.kdeplot(dummy_sample_H2_posteriorSample['sigma_round'][2,:,0,0].flatten(),  color='darkgreen', alpha=0.5)
sb.kdeplot(dummy_sample_H2_posteriorSample['sigma_round'][3,:,0,0].flatten(),  color='darkgreen', alpha=0.5)
sb.kdeplot(dummy_sample_H2_posteriorSample['sigma_round'][0,:,0,1].flatten(), label='$\sigma_{control,1}$', color='darkred', alpha=0.7)
sb.kdeplot(dummy_sample_H2_posteriorSample['sigma_round'][1,:,0,1].flatten(),  color='darkred', alpha=0.5)
sb.kdeplot(dummy_sample_H2_posteriorSample['sigma_round'][2,:,0,1].flatten(),  color='darkred', alpha=0.5)
sb.kdeplot(dummy_sample_H2_posteriorSample['sigma_round'][3,:,0,1].flatten(),  color='darkred', alpha=0.5)
sb.kdeplot(dummy_sample_H2_posteriorSample['sigma_round'][0,:,0,2].flatten(), label='$\sigma_{control,2}$', color='darkblue', alpha=0.7)
sb.kdeplot(dummy_sample_H2_posteriorSample['sigma_round'][1,:,0,2].flatten(),  color='darkblue', alpha=0.5)
sb.kdeplot(dummy_sample_H2_posteriorSample['sigma_round'][2,:,0,2].flatten(),  color='darkblue', alpha=0.5)
sb.kdeplot(dummy_sample_H2_posteriorSample['sigma_round'][3,:,0,2].flatten(),  color='darkblue', alpha=0.5)
ax.axvline(x=0.2, color='black', ls='--', lw=2, label='Cond.Value')
...
#%% Figure 3, right plot
fig,ax = plt.subplots(layout='constrained')
sb.kdeplot(dummy_sample_H2_posteriorSample['sigma_round'][0,:,1,0].flatten(), label='$\sigma_{treat,0}$', color='lightgreen', alpha=0.7)
sb.kdeplot(dummy_sample_H2_posteriorSample['sigma_round'][1,:,1,0].flatten(),  color='lightgreen', alpha=0.5)
sb.kdeplot(dummy_sample_H2_posteriorSample['sigma_round'][2,:,1,0].flatten(),  color='lightgreen', alpha=0.5)
sb.kdeplot(dummy_sample_H2_posteriorSample['sigma_round'][3,:,1,0].flatten(),  color='lightgreen', alpha=0.5)
sb.kdeplot(dummy_sample_H2_posteriorSample['sigma_round'][0,:,1,1].flatten(), label='$\sigma_{treat,1}$', color='darkorange', alpha=0.7)
sb.kdeplot(dummy_sample_H2_posteriorSample['sigma_round'][1,:,1,1].flatten(),  color='darkorange', alpha=0.5)
sb.kdeplot(dummy_sample_H2_posteriorSample['sigma_round'][2,:,1,1].flatten(),  color='darkorange', alpha=0.5)
sb.kdeplot(dummy_sample_H2_posteriorSample['sigma_round'][3,:,1,1].flatten(),  color='darkorange', alpha=0.5)
sb.kdeplot(dummy_sample_H2_posteriorSample['sigma_round'][0,:,1,2].flatten(), label='$\sigma_{treat,2}$', color='lightblue', alpha=0.7)
sb.kdeplot(dummy_sample_H2_posteriorSample['sigma_round'][1,:,1,2].flatten(),  color='lightblue', alpha=0.5)
sb.kdeplot(dummy_sample_H2_posteriorSample['sigma_round'][2,:,1,2].flatten(),  color='lightblue', alpha=0.5)
sb.kdeplot(dummy_sample_H2_posteriorSample['sigma_round'][3,:,1,2].flatten(),  color='lightblue', alpha=0.5)
ax.axvline(x=0.2, color='black', ls='--', lw=2, label='Cond.Value')
...
# Figure 4, left plot
fig,ax = plt.subplots(layout='constrained')
sb.kdeplot(dummy_sample_H3_posteriorSample['sigma_round'][0,:,0,0].flatten(), label='$\sigma_{control,0}$', color='darkgreen', alpha=0.7)
sb.kdeplot(dummy_sample_H3_posteriorSample['sigma_round'][1,:,0,0].flatten(),  color='darkgreen', alpha=0.5)
sb.kdeplot(dummy_sample_H3_posteriorSample['sigma_round'][2,:,0,0].flatten(),  color='darkgreen', alpha=0.5)
sb.kdeplot(dummy_sample_H3_posteriorSample['sigma_round'][3,:,0,0].flatten(),  color='darkgreen', alpha=0.5)
sb.kdeplot(dummy_sample_H3_posteriorSample['sigma_round'][0,:,0,1].flatten(), label='$\sigma_{control,1}$', color='darkred', alpha=0.7)
sb.kdeplot(dummy_sample_H3_posteriorSample['sigma_round'][1,:,0,1].flatten(),  color='darkred', alpha=0.5)
sb.kdeplot(dummy_sample_H3_posteriorSample['sigma_round'][2,:,0,1].flatten(),  color='darkred', alpha=0.5)
sb.kdeplot(dummy_sample_H3_posteriorSample['sigma_round'][3,:,0,1].flatten(),  color='darkred', alpha=0.5)
sb.kdeplot(dummy_sample_H3_posteriorSample['sigma_round'][0,:,0,2].flatten(), label='$\sigma_{control,2}$', color='darkblue', alpha=0.7)
sb.kdeplot(dummy_sample_H3_posteriorSample['sigma_round'][1,:,0,2].flatten(),  color='darkblue', alpha=0.5)
sb.kdeplot(dummy_sample_H3_posteriorSample['sigma_round'][2,:,0,2].flatten(),  color='darkblue', alpha=0.5)
sb.kdeplot(dummy_sample_H3_posteriorSample['sigma_round'][3,:,0,2].flatten(),  color='darkblue', alpha=0.5)
ax.set_xlabel('$\sigma_{control,r}$')
ax.set_ylabel('Density')
ax.axvline(x=0.2, color='black', ls='--', lw=2, label='Cond.Value')
ax.axvline(x=0.1, color='black', ls='--', lw=2)
...
#%% Figure 4, right plot
fig,ax = plt.subplots(layout='constrained')
sb.kdeplot(dummy_sample_H3_posteriorSample['sigma_round'][0,:,1,0].flatten(), label='$\sigma_{treat,0}$', color='lightgreen', alpha=0.7)
sb.kdeplot(dummy_sample_H3_posteriorSample['sigma_round'][1,:,1,0].flatten(),  color='lightgreen', alpha=0.5)
sb.kdeplot(dummy_sample_H3_posteriorSample['sigma_round'][2,:,1,0].flatten(),  color='lightgreen', alpha=0.5)
sb.kdeplot(dummy_sample_H3_posteriorSample['sigma_round'][3,:,1,0].flatten(),  color='lightgreen', alpha=0.5)
sb.kdeplot(dummy_sample_H3_posteriorSample['sigma_round'][0,:,1,1].flatten(), label='$\sigma_{treat,1}$', color='darkorange', alpha=0.7)
sb.kdeplot(dummy_sample_H3_posteriorSample['sigma_round'][1,:,1,1].flatten(),  color='darkorange', alpha=0.5)
sb.kdeplot(dummy_sample_H3_posteriorSample['sigma_round'][2,:,1,1].flatten(),  color='darkorange', alpha=0.5)
sb.kdeplot(dummy_sample_H3_posteriorSample['sigma_round'][3,:,1,1].flatten(),  color='darkorange', alpha=0.5)
sb.kdeplot(dummy_sample_H3_posteriorSample['sigma_round'][0,:,1,2].flatten(), label='$\sigma_{treat,2}$', color='lightblue', alpha=0.7)
sb.kdeplot(dummy_sample_H3_posteriorSample['sigma_round'][1,:,1,2].flatten(),  color='lightblue', alpha=0.5)
sb.kdeplot(dummy_sample_H3_posteriorSample['sigma_round'][2,:,1,2].flatten(),  color='lightblue', alpha=0.5)
sb.kdeplot(dummy_sample_H3_posteriorSample['sigma_round'][3,:,1,2].flatten(),  color='lightblue', alpha=0.5)
ax.set_xlabel('$\sigma_{treat,r}$')
ax.set_ylabel('Density')
...
# Figure 5, first row
fig,ax = plt.subplots(layout='constrained')
sb.kdeplot(dummy_sample_allH_posteriorSample['theta'][1,:,0,0].flatten(), label='$\\theta_{WR,0}$', color='green', alpha=0.7)
sb.kdeplot(dummy_sample_allH_posteriorSample['theta'][2,:,0,0].flatten(),  color='green', alpha=0.5)
sb.kdeplot(dummy_sample_allH_posteriorSample['theta'][3,:,0,0].flatten(),  color='green', alpha=0.5)
sb.kdeplot(dummy_sample_allH_posteriorSample['theta'][0,:,0,0].flatten(),  color='green', alpha=0.5)
sb.kdeplot(dummy_sample_allH_posteriorSample['theta'][0,:,1,0].flatten(), label='$\\theta_{SS,0}$', color='purple', alpha=0.7)
sb.kdeplot(dummy_sample_allH_posteriorSample['theta'][1,:,1,0].flatten(),  color='purple', alpha=0.5)
sb.kdeplot(dummy_sample_allH_posteriorSample['theta'][2,:,1,0].flatten(),  color='purple', alpha=0.5)
sb.kdeplot(dummy_sample_allH_posteriorSample['theta'][3,:,1,0].flatten(),  color='purple', alpha=0.5)
sb.kdeplot(dummy_sample_allH_posteriorSample['theta'][1,:,0,1].flatten(), label='$\\theta_{WR,1}$', color='red', alpha=0.7)
sb.kdeplot(dummy_sample_allH_posteriorSample['theta'][2,:,0,1].flatten(),  color='red', alpha=0.5)
sb.kdeplot(dummy_sample_allH_posteriorSample['theta'][3,:,0,1].flatten(),  color='red', alpha=0.5)
sb.kdeplot(dummy_sample_allH_posteriorSample['theta'][0,:,0,1].flatten(),  color='red', alpha=0.5)
sb.kdeplot(dummy_sample_allH_posteriorSample['theta'][0,:,1,1].flatten(), label='$\\theta_{SS,1}$', color='orange', alpha=0.5)
sb.kdeplot(dummy_sample_allH_posteriorSample['theta'][1,:,1,1].flatten(),  color='orange', alpha=0.5)
sb.kdeplot(dummy_sample_allH_posteriorSample['theta'][2,:,1,1].flatten(),  color='orange', alpha=0.5)
sb.kdeplot(dummy_sample_allH_posteriorSample['theta'][3,:,1,1].flatten(),  color='orange', alpha=0.5)
sb.kdeplot(dummy_sample_allH_posteriorSample['theta'][1,:,0,2].flatten(), label='$\\theta_{WR,2}$', color='blue', alpha=0.5)
sb.kdeplot(dummy_sample_allH_posteriorSample['theta'][2,:,0,2].flatten(),  color='blue', alpha=0.5)
sb.kdeplot(dummy_sample_allH_posteriorSample['theta'][3,:,0,2].flatten(),  color='blue', alpha=0.5)
sb.kdeplot(dummy_sample_allH_posteriorSample['theta'][0,:,0,2].flatten(),  color='blue', alpha=0.5)
sb.kdeplot(dummy_sample_allH_posteriorSample['theta'][0,:,1,2].flatten(), label='$\\theta_{SS,2}$', color='grey', alpha=0.5)
sb.kdeplot(dummy_sample_allH_posteriorSample['theta'][1,:,1,2].flatten(),  color='grey', alpha=0.5)
sb.kdeplot(dummy_sample_allH_posteriorSample['theta'][2,:,1,2].flatten(),  color='grey', alpha=0.5)
sb.kdeplot(dummy_sample_allH_posteriorSample['theta'][3,:,1,2].flatten(),  color='grey', alpha=0.5)
ax.axvline(x=-0.2, color='black', ls='--', lw=2, label='Cond. Value')
ax.axvline(x=0, color='black', ls='--', lw=2)
ax.set_xlabel('$\\theta_{r,tech}$')
ax.set_ylabel('Density')
...
fig,ax = plt.subplots(layout='constrained')
sb.kdeplot(dummy_sample_allH_posteriorSample['sigma_round'][0,:,0,0].flatten(), label='$\sigma_{control,0}$', color='darkgreen', alpha=0.7)
sb.kdeplot(dummy_sample_allH_posteriorSample['sigma_round'][1,:,0,0].flatten(),  color='darkgreen', alpha=0.5)
sb.kdeplot(dummy_sample_allH_posteriorSample['sigma_round'][2,:,0,0].flatten(),  color='darkgreen', alpha=0.5)
sb.kdeplot(dummy_sample_allH_posteriorSample['sigma_round'][3,:,0,0].flatten(),  color='darkgreen', alpha=0.5)
sb.kdeplot(dummy_sample_allH_posteriorSample['sigma_round'][0,:,0,1].flatten(), label='$\sigma_{control,1}$', color='darkred', alpha=0.7)
sb.kdeplot(dummy_sample_allH_posteriorSample['sigma_round'][1,:,0,1].flatten(),  color='darkred', alpha=0.5)
sb.kdeplot(dummy_sample_allH_posteriorSample['sigma_round'][2,:,0,1].flatten(),  color='darkred', alpha=0.5)
sb.kdeplot(dummy_sample_allH_posteriorSample['sigma_round'][3,:,0,1].flatten(),  color='darkred', alpha=0.5)
sb.kdeplot(dummy_sample_allH_posteriorSample['sigma_round'][0,:,0,2].flatten(), label='$\sigma_{control,2}$', color='darkblue', alpha=0.7)
sb.kdeplot(dummy_sample_allH_posteriorSample['sigma_round'][1,:,0,2].flatten(),  color='darkblue', alpha=0.5)
sb.kdeplot(dummy_sample_allH_posteriorSample['sigma_round'][2,:,0,2].flatten(),  color='darkblue', alpha=0.5)
sb.kdeplot(dummy_sample_allH_posteriorSample['sigma_round'][3,:,0,2].flatten(),  color='darkblue', alpha=0.5)
...
fig,ax = plt.subplots(layout='constrained')
sb.kdeplot(dummy_sample_allH_posteriorSample['sigma_round'][0,:,1,0].flatten(), label='$\sigma_{treat,0}$', color='lightgreen')
sb.kdeplot(dummy_sample_allH_posteriorSample['sigma_round'][1,:,1,0].flatten(),  color='lightgreen', alpha=0.5)
sb.kdeplot(dummy_sample_allH_posteriorSample['sigma_round'][2,:,1,0].flatten(),  color='lightgreen', alpha=0.5)
sb.kdeplot(dummy_sample_allH_posteriorSample['sigma_round'][3,:,1,0].flatten(),  color='lightgreen', alpha=0.5)
sb.kdeplot(dummy_sample_allH_posteriorSample['sigma_round'][0,:,1,1].flatten(), label='$\sigma_{treat,1}$', color='darkorange')
sb.kdeplot(dummy_sample_allH_posteriorSample['sigma_round'][1,:,1,1].flatten(),  color='darkorange', alpha=0.5)
sb.kdeplot(dummy_sample_allH_posteriorSample['sigma_round'][2,:,1,1].flatten(),  color='darkorange', alpha=0.5)
sb.kdeplot(dummy_sample_allH_posteriorSample['sigma_round'][3,:,1,1].flatten(),  color='darkorange', alpha=0.5)
sb.kdeplot(dummy_sample_allH_posteriorSample['sigma_round'][0,:,1,2].flatten(), label='$\sigma_{treat,2}$', color='lightblue')
sb.kdeplot(dummy_sample_allH_posteriorSample['sigma_round'][1,:,1,2].flatten(),  color='lightblue', alpha=0.5)
sb.kdeplot(dummy_sample_allH_posteriorSample['sigma_round'][2,:,1,2].flatten(),  color='lightblue', alpha=0.5)
sb.kdeplot(dummy_sample_allH_posteriorSample['sigma_round'][3,:,1,2].flatten(),  color='lightblue', alpha=0.5)
ax.axvline(x=0.15, color='black', ls='--', lw=2, label='Cond. Value')
ax.axvline(x=0.14, color='black', ls='--', lw=2)
ax.axvline(x=0.18, color='black', ls='--', lw=2)
ax.set_xlabel('$\sigma_{treat,r}$')
...
fig,ax = plt.subplots(layout='constrained')
sb.kdeplot(dummy_sample_allH_posteriorSample['beta_treat'][0,:,0].flatten(), label='$\\beta_{WR}$', color='orange', alpha=0.7)
sb.kdeplot(dummy_sample_allH_posteriorSample['beta_treat'][1,:,0].flatten(),  color='orange', alpha=0.5)
sb.kdeplot(dummy_sample_allH_posteriorSample['beta_treat'][2,:,0].flatten(),  color='orange', alpha=0.5)
sb.kdeplot(dummy_sample_allH_posteriorSample['beta_treat'][3,:,0].flatten(),  color='orange', alpha=0.5)
sb.kdeplot(dummy_sample_allH_posteriorSample['beta_treat'][0,:,1].flatten(), label='$\\beta_{SS}$', color='purple', alpha=0.7)
sb.kdeplot(dummy_sample_allH_posteriorSample['beta_treat'][1,:,1].flatten(),  color='purple', alpha=0.5)
sb.kdeplot(dummy_sample_allH_posteriorSample['beta_treat'][2,:,1].flatten(),  color='purple', alpha=0.5)
sb.kdeplot(dummy_sample_allH_posteriorSample['beta_treat'][3,:,1].flatten(),  color='purple', alpha=0.5)
...
fig,ax = plt.subplots(layout='constrained')
sb.kdeplot(samples_mcmc_noRound['beta_treat'][0,:,0].flatten(), label='$\\beta_{WR}$', color='orange', alpha=0.7)
sb.kdeplot(samples_mcmc_noRound['beta_treat'][1,:,0].flatten(),  color='orange', alpha=0.5)
sb.kdeplot(samples_mcmc_noRound['beta_treat'][2,:,0].flatten(),  color='orange', alpha=0.5)
sb.kdeplot(samples_mcmc_noRound['beta_treat'][3,:,0].flatten(),  color='orange', alpha=0.5)
sb.kdeplot(samples_mcmc_noRound['beta_treat'][0,:,1].flatten(), label='$\\beta_{SS}$', color='purple', alpha=0.7)
sb.kdeplot(samples_mcmc_noRound['beta_treat'][1,:,1].flatten(),  color='purple', alpha=0.5)
sb.kdeplot(samples_mcmc_noRound['beta_treat'][2,:,1].flatten(),  color='purple', alpha=0.5)
sb.kdeplot(samples_mcmc_noRound['beta_treat'][3,:,1].flatten(),  color='purple', alpha=0.5)
ax.set_xlabel('$\\beta_{tech}$')  
ax.axvline(x=0.2, color='black', ls='--', lw=2, label='Cond.Value')
ax.set_ylabel('Density')
ax.set_xlim([0,0.3])
